  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const formattedQuotes = allCarriers.map((carrier) => {
        const match = quotesArray.find((q: any) => q.transport_name === carrier)
            ...
            {carrierQuotes.map((quote, index) => (
              ...
              >
                ...
                {quote.available ? (
                  <>
                    <div className="mb-6">
                      <p className="text-lg font-semibold mb-2">Total Cost: ${quote.price} + Fuel Levy + GST</p>
