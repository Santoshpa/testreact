...
export function SessionInfo() {
  ...
  // Type guard to ensure tokenInfo has the required properties
  const isValidTokenInfo = (info: any): info is TokenInfo => {
    return (
      info &&
      typeof info.timeLeft === "number" &&
      typeof info.rememberMe === "boolean" &&
      info.expirationDate instanceof Date
    )
  }

  if (!tokenInfo || !isValidTokenInfo(tokenInfo)) return null
